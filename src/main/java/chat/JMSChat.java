...
public class JMSChat extends Application {
	...
	public void start(Stage stage) throws Exception {
	    ...
	    TextField textFieldId = new TextField("C1");
	    ...
	    TextField textFieldDestinataire=new TextField("C1");
	    textFieldDestinataire.setPrefWidth(250); 
	    textFieldDestinataire.setFont(new Font("Arial", 16));
	    
	    Label labelMessage=new Label("Message :");
	    TextArea textAreaMessage=new TextArea("Entrez votre message");
		  ...
		  try { 
			  ...
			  try {
				  if(message instanceof TextMessage) {
					  ...
					  observableListMg.add("R�ception de l'image : "+nomPhoto);
